...
function wp_default_scripts( $scripts ) {
	...
	$scripts->add( 'wp-codemirror', '/wp-includes/js/codemirror/codemirror.min.js', array(), '5.29.1-alpha-eeXXXDBPORTXXX7' );
...
function wp_default_styles( $styles ) {
	...
	$styles->add( 'wp-codemirror', '/wp-includes/js/codemirror/codemirror.min.css', array(), '5.29.1-alpha-eeXXXDBPORTXXX7' );
